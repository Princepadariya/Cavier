...
const HealthFaucets = () => {
  return (
    <section className="w-full bg-[#1F1F21] pt-10 md:pt-0 pb-16 md:pb-24 px-4 sm:px-6 md:px-12 lg:px-32">
      <div className="max-w-[1440px] mx-auto w-full">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {faucets.map((product) => (
            <div
              key={product.id}
              className="faucet-card flex flex-col group cursor-pointer"
            >
