...
join (values
  ...
  ('SO 04 102 | Bib Cock with Wall Flange', 'so-04-102-bib-cock', 'SO 04 102', 'sink-mixers', 1540,
   ...
   '[{"name":"Chrome","color":"#E8E8E8","filter":"grayscale(0) brightness(1) contrast(1)"},{"name":"Gold","color":"#D4B678","filter":"sepia(1) hue-rotate(5deg) saturate(1.8) brightness(0.9) contrast(1.1)"},{"name":"Antique Copper","color":"#8C5A3C","filter":"sepia(1) hue-rotate(-10deg) saturate(2) brightness(0.7) contrast(1.2)"}]',
  ...
  ('SO 04 103 | Angle Valve', 'so-04-103-angle-valve', 'SO 04 103', 'sink-mixers', 1200,
   ...
   '[{"name":"Chrome","color":"#E8E8E8","filter":"grayscale(0) brightness(1) contrast(1)"},{"name":"Antique Copper","color":"#8C5A3C","filter":"sepia(1) hue-rotate(-10deg) saturate(2) brightness(0.7) contrast(1.2)"}]',
  ...
  ('SO 04 106 | Sink Mixer with Swinging Spout', 'so-04-106-sink-mixer', 'SO 04 106', 'sink-mixers', 4250,
   ...
   '[{"name":"Chrome","color":"#E8E8E8","filter":"grayscale(0) brightness(1) contrast(1)"},{"name":"Gunmetal","color":"#6B6B6B","filter":"grayscale(1) brightness(0.6) contrast(1.4)"},{"name":"Antique Copper","color":"#8C5A3C","filter":"sepia(1) hue-rotate(-10deg) saturate(2) brightness(0.7) contrast(1.2)"}]',
  ...
  ('OP 01 | Opal Prime Basin Mixer', 'op-01-basin-mixer', 'OP 01', 'opal-prime', 2450,
   ...
   '[{"name":"Chrome","color":"#E8E8E8","filter":"grayscale(0) brightness(1) contrast(1)"},{"name":"Rose Gold","color":"#C27B5C","filter":"sepia(1) hue-rotate(-20deg) saturate(1.5) brightness(0.9) contrast(1.1)"},{"name":"Antique Copper","color":"#8C5A3C","filter":"sepia(1) hue-rotate(-10deg) saturate(2) brightness(0.7) contrast(1.2)"}]',
  ...
  ('BA 01 | Towel Rod', 'ba-01-towel-rod', 'BA 01', 'bathroom-accessories', 1600,
   ...
   '[{"name":"Chrome","color":"#E8E8E8","filter":"grayscale(0) brightness(1) contrast(1)"},{"name":"Matte Black","color":"#2B2B2B","filter":"grayscale(1) brightness(0.4) contrast(1.2)"},{"name":"Antique Copper","color":"#8C5A3C","filter":"sepia(1) hue-rotate(-10deg) saturate(2) brightness(0.7) contrast(1.2)"}]',
...
-- ---- TESTIMONIALS -----------------------------------------------------------
-- Not slug-keyed, so re-running this block will duplicate rows — only run once
-- (or clear the table first: `delete from public.testimonials;`).
insert into public.testimonials (name, role, quote, rating, sort_order, is_active)
values
  ('James Walker', 'Distributor',
   'Cavier products have exceeded our expectations in terms of durability and finish. The consistency in quality across orders makes them a reliable partner for our massive residential projects.',
   5, 1, true),
  ('Sarah Jenkins', 'Interior Designer',
   'The sleek designs and robust build quality of Cavier fittings have completely transformed the modern spaces I design. Clients are consistently thrilled with the luxurious feel.',
   5, 2, true),
  ('Michael Chen', 'Property Developer',
   'We switched to Cavier for all our high-end residential projects. The meticulous attention to detail and premium materials utilized are unmatched in the current market.',
   5, 3, true),
  ('Emma Thompson', 'Architect',
   'A perfect blend of aesthetics and functionality. Integrating Cavier products into my architectural plans adds a layer of sophisticated elegance that sets our buildings apart.',
   5, 4, true),
  ('David Rossi', 'Hotel Manager',
   'Our guests frequently compliment the bathroom fixtures. Upgrading to the Cavier collection was one of the best decisions we made for elevating our hotel''s luxury experience.',
   5, 5, true);
